<div class="table-wrapper p-0">
    <table id="bookingTable" class="table align-items-center table-responsive mb-0">
        ...
        <tbody>
                ...
                <tr>
                    <td data-order="{{ strtolower($brand->name) }}">
                        <div class="d-flex px-2 py-1">
                            ...
                            <p class="mb-0 text-sm font-weight-bold align-content-center">{{ $brand->name }}</p>
                        </div>
                    </td>
                    <td>
            ...
            @empty
                <td colspan="{{ auth()->user()->can('brand.edit') || auth()->user()->can('brand.delete') ? 5 : 4 }}" class="text-center" style="background-color: ghostwhite">
