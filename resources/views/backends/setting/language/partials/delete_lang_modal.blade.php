<!-- Modal -->
<div class="modal fade" id="deleteLangModal" tabindex="-1" role="dialog" aria-labelledby="deleteLangModalLabel" aria-hidden="true">
        ...
        <div class="modal-content" style="border-radius: 15px">
            <div class="modal-body p-4">
                ...
                <div class="description text-gray text-center pt-2 pb-3">
                    <small> Are you sure you want to delete this Language? </small>
                </div>
                <div class="button">
